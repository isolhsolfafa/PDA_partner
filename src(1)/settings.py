...
DEFAULT_TASKS = {
    'MECHANICAL': [
        "CABINET ASSY", "BURNER ASSY(TMS)", "WET TANK ASSY(TMS)",
        "3-WAY VALVE ASSY", "N2 LINE ASSY", "N2 TUBE ASSY",
        "CDA LINE ASSY", "CDA TUBE ASSY", "BCW LINE ASSY",
        "PCW LINE ASSY", "O2 LINE ASSY", "LNG LINE ASSY",
        "WASTE GAS LINE ASSY", "COOLING UNIT(TMS)", "REACTOR ASSY(TMS)",
        "HEATING JACKET", "CIR LINE TUBING", "설비 CLEANING", "자주검사"
    ],
    'ELECTRICAL': [
        "AC 백 판넬 작업", "DC 백 판넬 작업", "케비넷 준비 작업(덕트, 철거작업)",
        "판넬 취부 및 선분리", "내, 외부 작업", "탱크 작업", "판넬 작업",
        "탱크 도킹 후 결선 작업"
    ],
    'INSPECTION': [
        "LNG/Util", "Chamber", "I/O 체크, 가동 검사, 전장 마무리"
    ],
    'FINISHING': [
        "캐비넷 커버 장착 및 포장", "상부 마무리"
    ]
}
